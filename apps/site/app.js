...
const DATA = {
  ...
  career: [
    ...
    },
    {
      ...
      photos: ["assets/career/youla/iron-throne.webp", "assets/career/youla/backpack-patch.webp", "assets/career/youla/dark-theme.webp", "assets/career/youla/conference-talk.webp", "assets/career/youla/build-stats.webp", "assets/career/youla/old-logo.jpg", "assets/career/youla/new-logo-2020.jpg", "assets/career/youla/offsite-game.jpg"],
    },
    {
    ...
    },
    {
      ...
      highlights: {
        ...
        en: ["Reduced median build time by 35% — instrumented hundreds of daily CI and local builds (10,000+ Gradle tasks/day, ~1,000 modules) via Grafana dashboards with Slack alerts", "Migrated DI from Dagger 2 to Metro: 1.5× faster cold builds, unlocking team sandboxes", "Measured Android Studio/IntelliJ IDEA sync phases, built Grafana visualizations, and wrote an internal guide to fixing the bottlenecks", "Moved CI to Kotlin DSL: full build-variant coverage, localization checks, automated Docker image", "Set up App Bundle for Google Play and Huawei AppGallery", "Introduced Baseline Profiles for the launch flow: ~20% cold-start improvement", "Wrote autotests to catch redundant network requests at app startup", "Supported GMS-less Huawei devices — 5% of the user base in Mexico", "Founded Mobile Toolbox — an internal Android telemetry service designed to scale to other teams", "Made module-structure architecture decisions using Gradle Profiler and synthetic benchmark projects", "Helped stand up the app-security track — worked closely with AppSec, DevOps, and DWH", "Built the profile screen, theme switching, localization, and QR codes (ZXing) for launch; automated Jira transitions on pipeline events"],
      },
      photos: ["assets/career/plata/office-sign.jpg", "assets/career/plata/office-view.jpg", "assets/career/plata/ownership-board.png", "assets/career/plata/build-dashboard.png", "assets/career/plata/sync-phases.png", "assets/career/plata/daily-checks.png", "assets/career/plata/dagger-metro-meme.png"],
    },
    {
