...
const DATA = {
  ...
  career: [
    ...
    {
      id: "youla", glyph: "🛒", logo: "assets/career/youla/logo.webp",
      ...
      highlights: {
        ru: ["Маркетплейс: ~1,8 млн DAU, ~11,5 млн MAU, crash-free 99,9%", "Проектировал и развивал Android-архитектуру Юлы; определял технологические стандарты", "Внедрил Clean + MVI — провёл масштабный рефакторинг кодовой базы", "Сократил сетевые запросы при запуске с 6 до 1 за счёт миграции на GraphQL (Apollo)", "Реализовал мультистор-дистрибуцию: Google Play, Huawei AppGallery, RuStore", "Внедрил дизайн-систему, тёмную тему и нативные UI-тесты; интегрировался с внешними системами", "Разрабатывал внутренние инструменты: ленту с динамической рекламой, замеры перформанса", "Выступал на конференциях, вёл блог на Хабре"],
        en: ["Marketplace: ~1.8M DAU, ~11.5M MAU, 99.9% crash-free", "Designed and owned Youla's Android architecture; defined technology standards", "Introduced Clean + MVI — led a major codebase refactoring", "Reduced startup network calls from 6 to 1 via GraphQL (Apollo) migration", "Built multi-store distribution: Google Play, Huawei AppGallery, RuStore", "Introduced a design system, dark theme, and native UI tests; integrated with external systems", "Built internal tools: a dynamic-ad feed, performance measurement", "Spoke at conferences, ran a blog on Habr"],
      },
      photos: ["assets/career/youla/iron-throne.webp", "assets/career/youla/backpack-patch.webp", "assets/career/youla/dark-theme.webp", "assets/career/youla/conference-talk.webp", "assets/career/youla/build-stats.webp"],
    },
    {
      ...
      highlights: {
        ru: ["Удержал команду от распада в непростой 2022 год", "Ускорил холодный старт приложения Юла на 55%", "Запустил «Инициативные группы» — добровольную программу работы с техдолгом", "Выстроил кросс-командные практики: release management, бэклог техдолга с роадмапом устранения для бизнеса, найм"],
        en: ["Held the team together through a rough 2022", "Reduced Youla app cold start by 55%", "Launched Initiative Groups — a voluntary tech-debt program", "Established cross-team practices: release management, a tech-debt backlog with a remediation roadmap for the business, hiring"],
      },
