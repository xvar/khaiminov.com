  ...
  education: [
    {
      ...
      summary: { ru: "Официально поступил на бюджет — этим до сих пор горжусь. Несколько лет прожил в общаге. В казахстанский филиал приезжали читать лекции преподаватели из самого МГУ: от математических блоков вешался, но всё сдавал, а на программировании отдыхал душой. Годы в Москве были совсем другими — свой ритм, кафедра, специализация. Ну и, конечно, венец всего — диплом о предсказании производительности хорошо распараллеленных вычислений на кластере из видеокарт: мозги были загружены как никогда, так что первые годы работы после казались отдыхом.", en: "Got in on a state-funded spot — still proud of that. Lived in the dorm for a few years. Actual MSU professors from Moscow would come teach at the Kazakhstan branch: the math blocks nearly broke me (though I passed everything), while programming felt like a break. The years in Moscow itself were a different rhythm entirely — different department, different specialization. And the capstone of it all: a thesis on predicting the performance of well-parallelized computation on a GPU cluster — my brain was more loaded than it's ever been, so the first years of actual work felt like a vacation by comparison." },
      highlights: {
