  ...
  education: [
    {
      ...
      summary: { ru: "Официально поступил на бюджет — этим до сих пор горжусь. Несколько лет прожил в общаге. В казахстанский филиал приезжали читать лекции преподаватели из самого МГУ: от математических блоков вешался, но всё сдавал, а на программировании отдыхал душой. Годы в Москве были совсем другими — свой ритм, кафедра, специализация. Студенческая жизнь задела меня лишь по касательной, но было ощущение единения — пусть и в небольшом коллективе. А ещё была крышесносная несчастная любовь и друг, который стал почти как брат — привет и тёплые чувства всем, кто себя узнает. Ну и, конечно, венец всего — диплом о предсказании производительности хорошо распараллеленных вычислений на кластере из видеокарт: мозги были загружены как никогда, так что первые годы работы после казались отдыхом.", en: "Got in on a state-funded spot — still proud of that. Lived in the dorm for a few years. Actual MSU professors from Moscow would come teach at the Kazakhstan branch: the math blocks nearly broke me (though I passed everything), while programming felt like a break. The years in Moscow itself were a different rhythm entirely — different department, different specialization. Student life only brushed me in passing, but there was a sense of togetherness, even in a small crew. There was also a head-spinning, ill-fated love, and a friend who became almost like a brother — hi and warm feelings to anyone who recognizes themselves here. And the capstone of it all: a thesis on predicting the performance of well-parallelized computation on a GPU cluster — my brain was more loaded than it's ever been, so the first years of actual work felt like a vacation by comparison." },
      highlights: {
        ru: ["Поступил на бюджетное отделение", "В казахстанском филиале часть курсов читали преподаватели, приезжавшие из самого МГУ", "Дипломная работа — предсказание производительности хорошо распараллеленных вычислений на GPU-кластере"],
        en: ["Got a state-funded (budget) place", "Some courses at the Kazakhstan branch were taught by professors visiting from MSU itself", "Thesis: predicting the performance of well-parallelized computation on a GPU cluster"],
      },
      photos: ["assets/education/msu/red-square.webp", "assets/education/msu/main-building-terrace.webp", "assets/education/msu/moscow-skyline.webp"],
    },
    {
      id: "lyceum-165", glyph: "🎓",
